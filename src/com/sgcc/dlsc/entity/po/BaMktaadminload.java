...
/**
 * BaMktaadminload的POJO类
 *
 * @author  longshine  [Sat Mar 08 10:41:19 CST 2014]
 * 
 */
public class BaMktaadminload implements Serializable{

    /** 
     * 属性loadId
     */
    private String loadId;
//	private String trueLoadId;
    /** 
     * 属性participantId
     */
...
//	}
//
//	public void setAffnum(String affnum) {
//		this.affnum = affnum;
//	}
    /**
     * BaMktaadminload构造函数
     */
    public BaMktaadminload() {
        super();
    }  
	
    /**
     * BaMktaadminload完整的构造函数
     */  
    public BaMktaadminload(String loadId,Date validDate,String marketid,String guid){
        this.loadId = loadId;
...
//    public String getTrueLoadId(){
//        return trueLoadId;
//    }
//    public void setTrueLoadId(String loadId){
//        this.trueLoadId = loadId;
//    } 
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof BaMktaadminload))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        BaMktaadminload other = (BaMktaadminload) o;	        
