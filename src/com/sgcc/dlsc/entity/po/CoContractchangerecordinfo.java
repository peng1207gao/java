...
/**
 * CoContractchangerecordinfo的POJO类
 *
 * @author  xiabaike  [Fri Jan 24 10:44:23 CST 2014]
 * 
 */
public class CoContractchangerecordinfo implements Serializable{
    ...
    /**
     * CoContractchangerecordinfo构造函数
     */
    public CoContractchangerecordinfo() {
        super();
    }  
	
    /**
     * CoContractchangerecordinfo完整的构造函数
     */  
    public CoContractchangerecordinfo(String marketid,String contractid,BigDecimal isdelete,String versionid,String cmd,String operator,String operatingdescription,Date operatedate,BigDecimal orderno){
     ...
     * @return
     */
    public void setSellerenergy(String sellerenergy){
     ...
     * @return
     */
    public void setExpend3(Date expend3){
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof CoContractchangerecordinfo))
	        return false; 
			
        if(getVersionid() == null) 
	        return false;

        CoContractchangerecordinfo other = (CoContractchangerecordinfo) o;	        
