...
/**
 * BaBlockcapacityP2的POJO类
 *
 * @author  Administrator  [Wed Jul 17 16:27:57 CST 2013]
 * 
 */
public class BaBlockcapacityP2 implements Serializable{
    ...
    /**
     * BaBlockcapacityP2构造函数
     */
    public BaBlockcapacityP2() {
        super();
    }  
	
    /**
     * BaBlockcapacityP2完整的构造函数
     */  
    public BaBlockcapacityP2(String guid,String marketcode,BigDecimal dateType,Date tabdate,String hydropowerid){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof BaBlockcapacityP2))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        BaBlockcapacityP2 other = (BaBlockcapacityP2) o;	        
