...
/**
 * PubGeneOvhPlan的POJO类
 *
 * @author  Administrator  [Sun Feb 16 11:19:05 CST 2014]
 * 
 */
public class PubGeneOvhPlan implements Serializable{
     ...
     * PubGeneOvhPlan构造函数
     */
    public PubGeneOvhPlan() {
        super();
    }  
	
    /**
     * PubGeneOvhPlan完整的构造函数
     */  
    public PubGeneOvhPlan(String guid,String marketid,String facname,String macname,String facid,String macid,int tyear,int tmonth,int state,String fillinman,Date fillintime){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof PubGeneOvhPlan))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        PubGeneOvhPlan other = (PubGeneOvhPlan) o;	        
