...
/**
 * BaYpowerElecnext的POJO类
 *
 * @author  Administrator  [Fri Jul 19 10:26:51 CST 2013]
 * 
 */
public class BaYpowerElecnext implements Serializable{
    ...
    /**
     * BaYpowerElecnext构造函数
     */
    public BaYpowerElecnext() {
        super();
    }  
	
    /**
     * BaYpowerElecnext完整的构造函数
     */  
    public BaYpowerElecnext(String guid,String marketcode,Date tabDate){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof BaYpowerElecnext))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        BaYpowerElecnext other = (BaYpowerElecnext) o;	        
