...
/**
 * BaQpowerElecnext的POJO类
 *
 * @author  Administrator  [Mon Jul 22 09:44:43 CST 2013]
 * 
 */
public class BaQpowerElecnext implements Serializable{
    ...
    /**
     * BaQpowerElecnext构造函数
     */
    public BaQpowerElecnext() {
        super();
    }  
	
    /**
     * BaQpowerElecnext完整的构造函数
     */  
    public BaQpowerElecnext(String guid,String marketcode,Date tabDate){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof BaQpowerElecnext))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        BaQpowerElecnext other = (BaQpowerElecnext) o;	        
