...
/**
 * PaSpanareaprovinceSendlucre的POJO类
 *
 * @author  Administrator  [Sat Jun 15 14:48:47 CST 2013]
 * 
 */
public class PaSpanareaprovinceSendlucre implements Serializable{
     ...
     * 属性monthsaleeq
     */
    private BigDecimal monthsaleeq;
     ...
     * 属性monthsaleeqT
     */
    private BigDecimal monthsaleeqT;
    ...
    /**
     * PaSpanareaprovinceSendlucre构造函数
     */
    public PaSpanareaprovinceSendlucre() {
        super();
    }  
	
    /**
     * PaSpanareaprovinceSendlucre完整的构造函数
     */  
    public PaSpanareaprovinceSendlucre(String guid,String marketid,Date querydate,String theitemid){
        this.guid = guid;
    ...
    /**
     * 属性 monthsaleeq 的get方法
     * @return BigDecimal
     */
    public BigDecimal getMonthsaleeq(){
        return monthsaleeq;
    }
	
    /**
     * 属性 monthsaleeq 的set方法
     * @return
     */
    public void setMonthsaleeq(BigDecimal monthsaleeq){
        this.monthsaleeq = monthsaleeq;
    } 
    ...
    /**
     * 属性 monthsaleeqT 的get方法
     * @return BigDecimal
     */
    public BigDecimal getMonthsaleeqT(){
        return monthsaleeqT;
    }
	
    /**
     * 属性 monthsaleeqT 的set方法
     * @return
     */
    public void setMonthsaleeqT(BigDecimal monthsaleeqT){
        this.monthsaleeqT = monthsaleeqT;
    } 
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof PaSpanareaprovinceSendlucre))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        PaSpanareaprovinceSendlucre other = (PaSpanareaprovinceSendlucre) o;	        
	...
	public String toString(){
		  ...
		  return new StringBuffer()
            ...
            .append("monthsaleeq"+":"+getMonthsaleeq())
            .append("monthprice"+":"+getMonthprice())
            .append("monthincome"+":"+getMonthincome())
            .append("monthsaleeqT"+":"+getMonthsaleeqT())
