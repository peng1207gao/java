...
/**
 * BaDpowerSummer的POJO类
 *
 * @author  Administrator  [Wed Jul 17 16:28:35 CST 2013]
 * 
 */
public class BaDpowerSummer implements Serializable{
     ...
     * BaDpowerSummer构造函数
     */
    public BaDpowerSummer() {
        super();
    }  
	
    /**
     * BaDpowerSummer完整的构造函数
     */  
    public BaDpowerSummer(String guid,String marketcode,Date tabDate){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof BaDpowerSummer))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        BaDpowerSummer other = (BaDpowerSummer) o;	        
