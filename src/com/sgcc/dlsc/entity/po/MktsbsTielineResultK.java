...
/**
 * MktsbsTielineResultK的POJO类
 *
 * @author  Administrator  [Sat Jun 15 10:08:42 CST 2013]
 * 
 */
public class MktsbsTielineResultK implements Serializable{
	/**
	 * 
	 */
    ...
    /**
     * MktsbsTielineResultK构造函数
     */
    public MktsbsTielineResultK() {
        super();
    }  
	
    /**
     * MktsbsTielineResultK完整的构造函数
     */  
    public MktsbsTielineResultK(String id,BigDecimal mktMonth,String tielineGroupId,String saleUnitId,String vendeeUnitId,String recipientUnitId,String payerUnitId,String contractId,BigDecimal sbstypeId){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof MktsbsTielineResultK))
	        return false; 
			
        if(getId() == null) 
	        return false;

        MktsbsTielineResultK other = (MktsbsTielineResultK) o;	        
