...
/**
 * TrResultMainCalcu的POJO类
 *
 * @author  Administrator  [Thu Nov 07 14:00:08 CST 2013]
 * 
 */
public class TrResultMainCalcu implements Serializable{
    ...
    /**
     * TrResultMainCalcu构造函数
     */
    public TrResultMainCalcu() {
        super();
    }  
	
    /**
     * TrResultMainCalcu完整的构造函数
     */  
    public TrResultMainCalcu(String id,BigDecimal tradeseqId,BigDecimal intervalIndex,String saleUnitsId,String vendeeUnitsId,BigDecimal band,BigDecimal tradeTimepart){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof TrResultMainCalcu))
	        return false; 
			
        if(getId() == null) 
	        return false;

        TrResultMainCalcu other = (TrResultMainCalcu) o;	        
