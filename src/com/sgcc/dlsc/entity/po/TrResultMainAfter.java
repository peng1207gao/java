...
/**
 * TrResultMainAfter的POJO类
 *
 * @author  ym  [Thu Aug 22 10:17:20 CST 2013]
 * 
 */
public class TrResultMainAfter implements Serializable{
    ...
    /**
     * TrResultMainAfter构造函数
     */
    public TrResultMainAfter() {
        super();
    }  
	
    /**
     * TrResultMainAfter完整的构造函数
     */  
    public TrResultMainAfter(String id,BigDecimal tradeseqId,BigDecimal intervalIndex,String saleUnitsId,String vendeeUnitsId,BigDecimal band){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof TrResultMainAfter))
	        return false; 
			
        if(getId() == null) 
	        return false;

        TrResultMainAfter other = (TrResultMainAfter) o;	        
