...
/**
 * TrResultDecenergyCalcu的POJO类
 *
 * @author  lenovo  [Thu Aug 15 15:57:29 CST 2013]
 * 
 */
public class TrResultDecenergyCalcu implements Serializable{
    ...
    /**
     * TrResultDecenergyCalcu构造函数
     */
    public TrResultDecenergyCalcu() {
        super();
    }  
	
    /**
     * TrResultDecenergyCalcu完整的构造函数
     */  
    public TrResultDecenergyCalcu(String id,String tradeResultMainId,Date mktMonth){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof TrResultDecenergyCalcu))
	        return false; 
			
        if(getId() == null) 
	        return false;

        TrResultDecenergyCalcu other = (TrResultDecenergyCalcu) o;	        
