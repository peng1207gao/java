 ...
 * DwPowercorp的POJO类
 *
 * @author  zndw0  [Wed Mar 12 11:56:26 CST 2014]
 * 
 */
public class DwPowercorp implements Serializable{
     ...
     * DwPowercorp完整的构造函数
     */  
    public DwPowercorp(String marketid,String marketname){
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof DwPowercorp))
	        return false; 
			
        if(getMarketid() == null) 
	        return false;

        DwPowercorp other = (DwPowercorp) o;	        
