...
/**
 * PubBuildDirectTrade的POJO类
 *
 * @author  zhangyr  [Sun Mar 09 09:38:49 CST 2014]
 * 
 */
public class PubBuildDirectTrade implements Serializable{
    ...
    /**
     * PubBuildDirectTrade构造函数
     */
    public PubBuildDirectTrade() {
        super();
    }  
	
    /**
     * PubBuildDirectTrade完整的构造函数
     */  
    public PubBuildDirectTrade(String guid,String marketid,Integer tyear,Integer tmonth,Integer state,String fillinman,Date fillintime){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof PubBuildDirectTrade))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        PubBuildDirectTrade other = (PubBuildDirectTrade) o;	        
