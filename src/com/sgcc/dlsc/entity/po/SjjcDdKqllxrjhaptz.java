...
/**
 * SjjcDdKqllxrjhaptz的POJO类
 *
 * @author  Administrator  [Fri Mar 14 11:27:31 CST 2014]
 * 
 */
public class SjjcDdKqllxrjhaptz implements Serializable{
    ...
    /**
     * SjjcDdKqllxrjhaptz构造函数
     */
    public SjjcDdKqllxrjhaptz() {
        super();
    }  
	
    /**
     * SjjcDdKqllxrjhaptz完整的构造函数
     */  
    public SjjcDdKqllxrjhaptz(String objId,String companyname,String companyid,Date infoDate,String linename,String compositionname,Date infoTime){
        this.objId = objId;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof SjjcDdKqllxrjhaptz))
	        return false; 
			
        if(getObjId() == null) 
	        return false;

        SjjcDdKqllxrjhaptz other = (SjjcDdKqllxrjhaptz) o;	        
