 ...
 * PaExambenefit的POJO类
 *
 * @author  Administrator  [Sat Jun 15 14:48:14 CST 2013]
 * 
 */
public class PaExambenefit implements Serializable{
    ...
    /** 
     * 属性yearplanequalizerate
     */
    private BigDecimal yearplanequalizerate;
	
    /** 
     * 属性monthbuysaleq
     */
    private BigDecimal monthbuysaleq;
     ...
     * PaExambenefit构造函数
     */
    public PaExambenefit() {
        super();
    }  
	
    /**
     * PaExambenefit完整的构造函数
     */  
    public PaExambenefit(String guid,String marketid,Date theyearmonth){
        this.guid = guid;
    ...
    /**
     * 属性 theyearmonth 的get方法
     * @return Date
     */
    public Date getTheyearmonth(){
        return theyearmonth;
    }
	
    /**
     * 属性 theyearmonth 的set方法
     * @return
     */
    public void setTheyearmonth(Date theyearmonth){
        this.theyearmonth = theyearmonth;
    } 
    ...
    /**
     * 属性 yearplanequalizerate 的get方法
     * @return BigDecimal
     */
    public BigDecimal getYearplanequalizerate(){
        return yearplanequalizerate;
    }
	
    /**
     * 属性 yearplanequalizerate 的set方法
     * @return
     */
    public void setYearplanequalizerate(BigDecimal yearplanequalizerate){
        this.yearplanequalizerate = yearplanequalizerate;
    } 
	
    /**
     * 属性 monthbuysaleq 的get方法
     * @return BigDecimal
     */
    public BigDecimal getMonthbuysaleq(){
        return monthbuysaleq;
    }
	
    /**
     * 属性 monthbuysaleq 的set方法
     * @return
     */
    public void setMonthbuysaleq(BigDecimal monthbuysaleq){
        this.monthbuysaleq = monthbuysaleq;
    } 
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof PaExambenefit))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        PaExambenefit other = (PaExambenefit) o;	        
	...
	public String toString(){
		  ...
		  return new StringBuffer()
            ...
            .append("theyearmonth"+":"+getTheyearmonth())
            .append("monthplanequalizerate"+":"+getMonthplanequalizerate())
            .append("yearplanequalizerate"+":"+getYearplanequalizerate())
            .append("monthbuysaleq"+":"+getMonthbuysaleq())
