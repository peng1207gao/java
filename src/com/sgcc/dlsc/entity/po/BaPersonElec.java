 ...
 * BaPersonElec的POJO类
 *
 * @author  Administrator  [Wed Jul 17 16:34:30 CST 2013]
 * 
 */
public class BaPersonElec implements Serializable{
     ...
     * BaPersonElec完整的构造函数
     */  
    public BaPersonElec(String guid,String marketcode,BigDecimal dateType,Date tabDate,BigDecimal datatype){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof BaPersonElec))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        BaPersonElec other = (BaPersonElec) o;	        
