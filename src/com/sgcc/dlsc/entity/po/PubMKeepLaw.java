 ...
 * PubMKeepLaw的POJO类
 *
 * @author  admin  [Mon Mar 10 14:16:07 CST 2014]
 * 
 */
public class PubMKeepLaw implements Serializable{
     ...
     * PubMKeepLaw完整的构造函数
     */  
    public PubMKeepLaw(String guid,String marketid,Integer tyear,Integer tmonth,String remark,String fillinman,Date fillintime){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof PubMKeepLaw))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        PubMKeepLaw other = (PubMKeepLaw) o;	        
