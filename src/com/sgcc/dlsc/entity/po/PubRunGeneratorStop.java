...
/**
 * PubRunGeneratorStop的POJO类
 *
 * @author  Administrator  [Sat Mar 01 20:15:37 CST 2014]
 * 
 */
public class PubRunGeneratorStop implements Serializable{
    ...
    /**
     * PubRunGeneratorStop构造函数
     */
    public PubRunGeneratorStop() {
        super();
    }  
	
    /**
     * PubRunGeneratorStop完整的构造函数
     */  
    public PubRunGeneratorStop(String guid,String marketid,int tyear,int tmonth,BigDecimal state,String fillinman,Date fillintime){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof PubRunGeneratorStop))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        PubRunGeneratorStop other = (PubRunGeneratorStop) o;	        
