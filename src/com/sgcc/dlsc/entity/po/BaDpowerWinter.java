...
/**
 * BaDpowerWinter的POJO类
 *
 * @author  Administrator  [Wed Jul 17 16:28:44 CST 2013]
 * 
 */
public class BaDpowerWinter implements Serializable{
     ...
     * BaDpowerWinter构造函数
     */
    public BaDpowerWinter() {
        super();
    }  
	
    /**
     * BaDpowerWinter完整的构造函数
     */  
    public BaDpowerWinter(String guid,String marketcode,BigDecimal tabDate){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof BaDpowerWinter))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        BaDpowerWinter other = (BaDpowerWinter) o;	        
