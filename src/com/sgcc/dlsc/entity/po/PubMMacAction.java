 ...
 * PubMMacAction的POJO类
 *
 * @author  yangguang  [Mon Mar 10 16:12:07 CST 2014]
 * 
 */
public class PubMMacAction implements Serializable{
     ...
     * PubMMacAction构造函数
     */
    public PubMMacAction() {
        super();
    }  
	
    /**
     * PubMMacAction完整的构造函数
     */  
    public PubMMacAction(String guid,String marketid,int tyear,int tmonth,int state,String fillinman,Date fillintime){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof PubMMacAction))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        PubMMacAction other = (PubMMacAction) o;	        
