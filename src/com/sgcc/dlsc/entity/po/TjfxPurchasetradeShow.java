...
/**
 * TjfxPurchasetradeShow的POJO类
 *
 * @author  Administrator  [Thu Oct 31 15:52:09 CST 2013]
 * 
 */
public class TjfxPurchasetradeShow implements Serializable{
    ...
    /**
     * TjfxPurchasetradeShow构造函数
     */
    public TjfxPurchasetradeShow() {
        super();
    }  
	
    /**
     * TjfxPurchasetradeShow完整的构造函数
     */  
    public TjfxPurchasetradeShow(String guid,Date mktMonth,String tjname,String marketid){
        this.guid = guid;
     ...
     * @return
     */
    public void setLjhour(BigDecimal ljhour){
        this.ljhour = ljhour;
    } 
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof TjfxPurchasetradeShow))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        TjfxPurchasetradeShow other = (TjfxPurchasetradeShow) o;	        
