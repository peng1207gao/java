 ...
 * TjRptPerson的POJO类
 *
 * @author  admin  [Thu Jul 17 15:27:40 CST 2014]
 * 
 */
public class TjRptPerson implements Serializable{
     ...
     * TjRptPerson完整的构造函数
     */  
    public TjRptPerson(String guid,String marketid,String personid){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof TjRptPerson))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        TjRptPerson other = (TjRptPerson) o;	        
