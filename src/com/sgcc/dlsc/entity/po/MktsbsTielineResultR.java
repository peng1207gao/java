...
/**
 * MktsbsTielineResultR的POJO类
 *
 * @author  Administrator  [Sat Jun 15 10:09:04 CST 2013]
 * 
 */
public class MktsbsTielineResultR implements Serializable{
	/**
	 * 
	 */
    ...
    /**
     * MktsbsTielineResultR构造函数
     */
    public MktsbsTielineResultR() {
        super();
    }  
	
    /**
     * MktsbsTielineResultR完整的构造函数
     */  
    public MktsbsTielineResultR(String id,BigDecimal mktMonth,String tielineGroupId,String saleUnitId,String vendeeUnitId,String recipientUnitId,String payerUnitId,String contractId,BigDecimal sbstypeId){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof MktsbsTielineResultR))
	        return false; 
			
        if(getId() == null) 
	        return false;

        MktsbsTielineResultR other = (MktsbsTielineResultR) o;	        
