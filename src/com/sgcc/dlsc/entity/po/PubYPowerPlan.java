 ...
 * PubYPowerPlan的POJO类
 *
 * @author  Administrator  [Thu Mar 27 18:58:34 CST 2014]
 * 
 */
public class PubYPowerPlan implements Serializable{
     ...
     * PubYPowerPlan构造函数
     */
    public PubYPowerPlan() {
        super();
    }  
	
    /**
     * PubYPowerPlan完整的构造函数
     */  
    public PubYPowerPlan(String guid,String marketid,BigDecimal tyear,BigDecimal state,String fillinman,Date fillintime){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof PubYPowerPlan))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        PubYPowerPlan other = (PubYPowerPlan) o;	        
