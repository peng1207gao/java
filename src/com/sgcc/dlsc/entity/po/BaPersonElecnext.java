...
/**
 * BaPersonElecnext的POJO类
 *
 * @author  Administrator  [Wed Jul 17 16:34:38 CST 2013]
 * 
 */
public class BaPersonElecnext implements Serializable{
    ...
    /**
     * BaPersonElecnext构造函数
     */
    public BaPersonElecnext() {
        super();
    }  
	
    /**
     * BaPersonElecnext完整的构造函数
     */  
    public BaPersonElecnext(String guid,String marketcode,BigDecimal dateType,Date tabDate){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof BaPersonElecnext))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        BaPersonElecnext other = (BaPersonElecnext) o;	        
