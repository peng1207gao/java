...
/**
 * PaSettleUnitResult的POJO类
 *
 * @author  Administrator  [Sat Jun 15 10:09:12 CST 2013]
 * 
 */
public class PaSettleUnitResult implements Serializable{
	/**
	 * 
	 */
    ...
    /**
     * PaSettleUnitResult构造函数
     */
    public PaSettleUnitResult() {
        super();
    }  
	
    /**
     * PaSettleUnitResult完整的构造函数
     */  
    public PaSettleUnitResult(String guid,String marketid,Date querydate,String sbsUnitId,String sbsUnitname,BigDecimal effectivetype){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof PaSettleUnitResult))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        PaSettleUnitResult other = (PaSettleUnitResult) o;	        
