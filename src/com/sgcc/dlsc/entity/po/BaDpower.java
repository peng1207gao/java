 ...
 * BaDpower的POJO类
 *
 * @author  Administrator  [Wed Jul 17 16:28:52 CST 2013]
 * 
 */
public class BaDpower implements Serializable{
     ...
     * BaDpower完整的构造函数
     */  
    public BaDpower(String guid,String marketcode){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof BaDpower))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        BaDpower other = (BaDpower) o;	        
