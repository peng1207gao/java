...
/**
 * TrPageDisplayConfigModel的POJO类
 *
 * @author  DWJ  [Sat Apr 12 10:10:59 CST 2014]
 * 
 */
public class TrPageDisplayConfigModel implements Serializable{
    ...
    /**
     * TrPageDisplayConfigModel构造函数
     */
    public TrPageDisplayConfigModel() {
        super();
    }  
	
    /**
     * TrPageDisplayConfigModel完整的构造函数
     */  
    public TrPageDisplayConfigModel(String guid,String tradetypeCode,String pageId,String columnPhysicsName,BigDecimal columnIsDisplay,String columnDisplayName){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof TrPageDisplayConfigModel))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        TrPageDisplayConfigModel other = (TrPageDisplayConfigModel) o;	        
