...
/**
 * PaSettleDetailD的POJO类
 *
 * @author  Administrator  [Mon Jun 17 17:22:27 CST 2013]
 * 
 */
public class PaSettleDetailD implements Serializable{
     ...
     * 属性daygenereq
     */
    private BigDecimal daygenereq;
	
    /** 
     * 属性dayeq
     */
    private BigDecimal dayeq;
     ...
     * 属性dayfree
     */
    private BigDecimal dayfree;
	
    /** 
     * 属性daygenereqTM
     */
    private BigDecimal daygenereqTM;
	
    /** 
     * 属性dayeqTM
     */
    private BigDecimal dayeqTM;
     ...
     * 属性dayfreeTM
     */
    private BigDecimal dayfreeTM;
	
    /** 
     * 属性daygenereqTY
     */
    private BigDecimal daygenereqTY;
	
    /** 
     * 属性dayeqTY
     */
    private BigDecimal dayeqTY;
     ...
     * PaSettleDetailD构造函数
     */
    public PaSettleDetailD() {
        super();
    }  
	
    /**
     * PaSettleDetailD完整的构造函数
     */  
    public PaSettleDetailD(String guid){
        this.guid = guid;
    }
    ...
    /**
     * 属性 daygenereq 的get方法
     * @return BigDecimal
     */
    public BigDecimal getDaygenereq(){
        return daygenereq;
    }
	
    /**
     * 属性 daygenereq 的set方法
     * @return
     */
    public void setDaygenereq(BigDecimal daygenereq){
        this.daygenereq = daygenereq;
    } 
     ...
     * @return
     */
    public void setDayeq(BigDecimal dayeq){
        this.dayeq = dayeq;
    } 
     ...
     * @return
     */
    public void setDayfree(BigDecimal dayfree){
        this.dayfree = dayfree;
    } 
	
    /**
     * 属性 daygenereqTM 的get方法
     * @return BigDecimal
     */
    public BigDecimal getDaygenereqTM(){
        return daygenereqTM;
    }
	
    /**
     * 属性 daygenereqTM 的set方法
     * @return
     */
    public void setDaygenereqTM(BigDecimal daygenereqTM){
        this.daygenereqTM = daygenereqTM;
    } 
     ...
     * @return
     */
    public void setDayeqTM(BigDecimal dayeqTM){
        this.dayeqTM = dayeqTM;
    } 
     ...
     * @return BigDecimal
     */
    public BigDecimal getDayfreeTM(){
        return dayfreeTM;
    }
     ...
     * @return
     */
    public void setDayfreeTM(BigDecimal dayfreeTM){
        this.dayfreeTM = dayfreeTM;
    } 
	
    /**
     * 属性 daygenereqTY 的get方法
     * @return BigDecimal
     */
    public BigDecimal getDaygenereqTY(){
        return daygenereqTY;
    }
	
    /**
     * 属性 daygenereqTY 的set方法
     * @return
     */
    public void setDaygenereqTY(BigDecimal daygenereqTY){
        this.daygenereqTY = daygenereqTY;
    } 
     ...
     * @return
     */
    public void setDayeqTY(BigDecimal dayeqTY){
        this.dayeqTY = dayeqTY;
    } 
     ...
     * @return BigDecimal
     */
    public BigDecimal getDayfreeTY(){
        return dayfreeTY;
    }
     ...
     * @return
     */
    public void setDayfreeTY(BigDecimal dayfreeTY){
        this.dayfreeTY = dayfreeTY;
    } 
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof PaSettleDetailD))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        PaSettleDetailD other = (PaSettleDetailD) o;	        
	...
	public String toString(){
		  ...
		  return new StringBuffer()
            ...
            .append("daygenereq"+":"+getDaygenereq())
            .append("dayeq"+":"+getDayeq())
            .append("dayplaneq"+":"+getDayplaneq())
            .append("dayfree"+":"+getDayfree())
            .append("daygenereqTM"+":"+getDaygenereqTM())
            .append("dayeqTM"+":"+getDayeqTM())
            .append("monplaneq"+":"+getMonplaneq())
            .append("dayfreeTM"+":"+getDayfreeTM())
            .append("daygenereqTY"+":"+getDaygenereqTY())
            .append("dayeqTY"+":"+getDayeqTY())
            .append("yearplaneq"+":"+getYearplaneq())
            .append("dayfreeTY"+":"+getDayfreeTY())
