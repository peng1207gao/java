...
/**
 * PubTmCjddlscdldlphfsb的POJO类
 *
 * @author  yonggan  [Tue Jul 15 15:45:45 CST 2014]
 * 
 */
public class PubTmCjddlscdldlphfsb implements Serializable{
    ...
    /**
     * PubTmCjddlscdldlphfsb构造函数
     */
    public PubTmCjddlscdldlphfsb() {
        super();
    }  
	
    /**
     * PubTmCjddlscdldlphfsb完整的构造函数
     */  
    public PubTmCjddlscdldlphfsb(String guid,BigDecimal tyear,BigDecimal tmonth,String markerid,BigDecimal state,String fillinman,Date fillintime){
        this.guid = guid;
        this.tyear = tyear;
        this.tmonth = tmonth;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof PubTmCjddlscdldlphfsb))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        PubTmCjddlscdldlphfsb other = (PubTmCjddlscdldlphfsb) o;	        
