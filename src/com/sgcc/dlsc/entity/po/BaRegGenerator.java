...
/**
 * BaRegGenerator的POJO类
 *
 * @author  longshine  [Tue Mar 18 20:39:08 CST 2014]
 * 
 */
public class BaRegGenerator implements Serializable{
     ...
     * BaRegGenerator构造函数
     */
    public BaRegGenerator() {
        super();
    }  
	
    /**
     * BaRegGenerator完整的构造函数
     */  
    public BaRegGenerator(String generatorid,String generatorname,String plantid,BigDecimal generatortype,Date starteffectivedate,String marketid){
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof BaRegGenerator))
	        return false; 
			
        if(getGeneratorid() == null) 
	        return false;

        BaRegGenerator other = (BaRegGenerator) o;	        
