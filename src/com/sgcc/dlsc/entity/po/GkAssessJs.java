 ...
 * GkAssessJs的POJO类
 *
 * @author  Administrator  [Thu Aug 15 15:28:21 CST 2013]
 * 
 */
public class GkAssessJs implements Serializable{
     ...
     * GkAssessJs完整的构造函数
     */  
    public GkAssessJs(String guid,String marketcode){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof GkAssessJs))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        GkAssessJs other = (GkAssessJs) o;	        
