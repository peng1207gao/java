 ...
 * BaElec的POJO类
 *
 * @author  Administrator  [Wed Jul 17 16:29:02 CST 2013]
 * 
 */
public class BaElec implements Serializable{
     ...
     * BaElec完整的构造函数
     */  
    public BaElec(String guid,String marketcode,BigDecimal dateType,Date tabDate,BigDecimal datatype){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof BaElec))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        BaElec other = (BaElec) o;	        
