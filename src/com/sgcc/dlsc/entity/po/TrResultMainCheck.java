...
/**
 * TrResultMainCheck的POJO类
 *
 * @author  sss  [Tue Nov 12 15:24:50 CST 2013]
 * 
 */
public class TrResultMainCheck implements Serializable{
    ...
    /**
     * TrResultMainCheck构造函数
     */
    public TrResultMainCheck() {
        super();
    }  
	
    /**
     * TrResultMainCheck完整的构造函数
     */  
    public TrResultMainCheck(String id,BigDecimal tradeseqId,BigDecimal intervalIndex,String saleUnitsId,String vendeeUnitsId,BigDecimal band){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof TrResultMainCheck))
	        return false; 
			
        if(getId() == null) 
	        return false;

        TrResultMainCheck other = (TrResultMainCheck) o;	        
