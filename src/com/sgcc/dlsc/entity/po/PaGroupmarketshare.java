...
/**
 * PaGroupmarketshare的POJO类
 *
 * @author  Administrator  [Sat Jun 15 14:48:07 CST 2013]
 * 
 */
public class PaGroupmarketshare implements Serializable{
    ...
    /**
     * PaGroupmarketshare构造函数
     */
    public PaGroupmarketshare() {
        super();
    }  
	
    /**
     * PaGroupmarketshare完整的构造函数
     */  
    public PaGroupmarketshare(String guid,String marketid,Date theyear,String gengroupid){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof PaGroupmarketshare))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        PaGroupmarketshare other = (PaGroupmarketshare) o;	        
