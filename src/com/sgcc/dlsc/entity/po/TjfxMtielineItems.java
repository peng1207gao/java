...
/**
 * TjfxMtielineItems的POJO类
 *
 * @author  sss  [Mon Nov 11 12:05:35 CST 2013]
 * 
 */
public class TjfxMtielineItems implements Serializable{
     ...
     * 属性isForward
     */
    private BigDecimal isForward;
	
    /**
     * TjfxMtielineItems构造函数
     */
    public TjfxMtielineItems() {
        super();
    }  
	
    /**
     * TjfxMtielineItems完整的构造函数
     */  
    public TjfxMtielineItems(String id,String marketId,Date planDate,String versionId,String plantypeId,String contractId,BigDecimal bandIndex,BigDecimal contractType,BigDecimal sellerBusid,BigDecimal vendeeBusid,BigDecimal isForward){
        this.id = id;
     ...
     * @return BigDecimal
     */
    public BigDecimal getIsForward(){
        return isForward;
    }
     ...
     * @return
     */
    public void setIsForward(BigDecimal isForward){
        this.isForward = isForward;
    } 
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof TjfxMtielineItems))
	        return false; 
			
        if(getId() == null) 
	        return false;

        TjfxMtielineItems other = (TjfxMtielineItems) o;	        
