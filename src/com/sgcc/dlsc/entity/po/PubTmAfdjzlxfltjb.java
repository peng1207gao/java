...
/**
 * PubTmAfdjzlxfltjb的POJO类
 *
 * @author  lenovo  [Wed Jun 11 14:38:12 CST 2014]
 * 
 */
public class PubTmAfdjzlxfltjb implements Serializable{
    ...
    /**
     * PubTmAfdjzlxfltjb构造函数
     */
    public PubTmAfdjzlxfltjb() {
        super();
    }  
	
    /**
     * PubTmAfdjzlxfltjb完整的构造函数
     */  
    public PubTmAfdjzlxfltjb(String guid,BigDecimal tyear,BigDecimal tmonth,String markerid,BigDecimal state,String fillinman,Date fillintime){
        this.guid = guid;
        this.tyear = tyear;
        this.tmonth = tmonth;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof PubTmAfdjzlxfltjb))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        PubTmAfdjzlxfltjb other = (PubTmAfdjzlxfltjb) o;	        
