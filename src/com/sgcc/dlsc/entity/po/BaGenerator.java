 ...
 * BaGenerator的POJO类
 *
 * @author  liyuan  [Fri Jan 24 09:21:35 CST 2014]
 * 
 */
public class BaGenerator implements Serializable{
     ...
     * BaGenerator完整的构造函数
     */  
    public BaGenerator(String generatorid,String generatorname,String plantid,Date starteffectivedate,String marketid){
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof BaGenerator))
	        return false; 
			
        if(getGeneratorid() == null) 
	        return false;

        BaGenerator other = (BaGenerator) o;	        
