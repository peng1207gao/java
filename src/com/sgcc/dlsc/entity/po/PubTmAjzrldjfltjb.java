...
/**
 * PubTmAjzrldjfltjb的POJO类
 *
 * @author  lenovo  [Wed Jun 11 14:40:58 CST 2014]
 * 
 */
public class PubTmAjzrldjfltjb implements Serializable{
    ...
    /**
     * PubTmAjzrldjfltjb构造函数
     */
    public PubTmAjzrldjfltjb() {
        super();
    }  
	
    /**
     * PubTmAjzrldjfltjb完整的构造函数
     */  
    public PubTmAjzrldjfltjb(String guid,BigDecimal tyear,BigDecimal tmonth,String markerid,BigDecimal state,String fillinman,Date fillintime){
        this.guid = guid;
        this.tyear = tyear;
        this.tmonth = tmonth;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof PubTmAjzrldjfltjb))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        PubTmAjzrldjfltjb other = (PubTmAjzrldjfltjb) o;	        
