...
/**
 * SjjcDdZddcsjswdl的POJO类
 *
 * @author  Administrator  [Mon Mar 17 10:04:13 CST 2014]
 * 
 */
public class SjjcDdZddcsjswdl implements Serializable{
    ...
    /**
     * SjjcDdZddcsjswdl构造函数
     */
    public SjjcDdZddcsjswdl() {
        super();
    }  
	
    /**
     * SjjcDdZddcsjswdl完整的构造函数
     */  
    public SjjcDdZddcsjswdl(String objId,String companyname,String companyid,Date infoDate,String plantname,Date infoTime){
        this.objId = objId;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof SjjcDdZddcsjswdl))
	        return false; 
			
        if(getObjId() == null) 
	        return false;

        SjjcDdZddcsjswdl other = (SjjcDdZddcsjswdl) o;	        
