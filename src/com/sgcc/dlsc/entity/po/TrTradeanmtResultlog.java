...
/**
 * TrTradeanmtResultlog的POJO类
 *
 * @author  DWJ  [Thu Jun 26 10:43:03 CST 2014]
 * 
 */
public class TrTradeanmtResultlog implements Serializable{
    ...
    private String refreshRole;
    
    /**
     * TrTradeanmtResultlog构造函数
     */
    public TrTradeanmtResultlog() {
        super();
    }  
	
    /**
     * TrTradeanmtResultlog完整的构造函数
     */  
    public TrTradeanmtResultlog(String id,BigDecimal tradeseqId,String jydyId,String marketId,BigDecimal tradeTimepart){
        this.id = id;
    ...
    public String getRefreshRole() {
		return refreshRole;
	}

	public void setRefreshRole(String refreshRole) {
		this.refreshRole = refreshRole;
	}
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof TrTradeanmtResultlog))
	        return false; 
			
        if(getId() == null) 
	        return false;

        TrTradeanmtResultlog other = (TrTradeanmtResultlog) o;	        
