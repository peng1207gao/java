...
/**
 * TrResultDecenergy的POJO类
 *
 * @author  MengKe  [Thu Aug 15 16:02:53 CST 2013]
 * 
 */
public class TrResultDecenergy implements Serializable{
    ...
    /**
     * TrResultDecenergy构造函数
     */
    public TrResultDecenergy() {
        super();
    }  
	
    /**
     * TrResultDecenergy完整的构造函数
     */  
    public TrResultDecenergy(String id,String tradeResultMainId,Date mktMonth){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof TrResultDecenergy))
	        return false; 
			
        if(getId() == null) 
	        return false;

        TrResultDecenergy other = (TrResultDecenergy) o;	        
