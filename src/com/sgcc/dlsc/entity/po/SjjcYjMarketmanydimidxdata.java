...
/**
 * SjjcYjMarketmanydimidxdata的POJO类
 *
 * @author  Administrator  [Wed Jul 23 14:40:18 CST 2014]
 * 
 */
public class SjjcYjMarketmanydimidxdata implements Serializable{
    ...
    /**
     * SjjcYjMarketmanydimidxdata构造函数
     */
    public SjjcYjMarketmanydimidxdata() {
        super();
    }  
	
    /**
     * SjjcYjMarketmanydimidxdata完整的构造函数
     */  
    public SjjcYjMarketmanydimidxdata(String fguid){
        this.fguid = fguid;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof SjjcYjMarketmanydimidxdata))
	        return false; 
			
        if(getFguid() == null) 
	        return false;

        SjjcYjMarketmanydimidxdata other = (SjjcYjMarketmanydimidxdata) o;	        
