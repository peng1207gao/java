...
/**
 * BaRegMarketparticipant的POJO类
 *
 * @author  longshine  [Tue Mar 25 15:03:47 CST 2014]
 * 
 */
public class BaRegMarketparticipant implements Serializable{
    ...
    /**
     * BaRegMarketparticipant构造函数
     */
    public BaRegMarketparticipant() {
        super();
    }  
	
    /**
     * BaRegMarketparticipant完整的构造函数
     */  
    public BaRegMarketparticipant(String participantid,String participantname,BigDecimal participanttype,String participantcode,String marketid,Date starteffectivedate){
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof BaRegMarketparticipant))
	        return false; 
			
        if(getParticipantid() == null) 
	        return false;

        BaRegMarketparticipant other = (BaRegMarketparticipant) o;	        
