...
/**
 * PubMPowerWater的POJO类
 *
 * @author  zndw1  [Sat Mar 08 12:31:01 CST 2014]
 * 
 */
public class PubMPowerWater implements Serializable{
     ...
     * PubMPowerWater构造函数
     */
    public PubMPowerWater() {
        super();
    }  
	
    /**
     * PubMPowerWater完整的构造函数
     */  
    public PubMPowerWater(String guid,String marketid,int tyear,int tmonth,int state,String fillinman,Date fillintime){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof PubMPowerWater))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        PubMPowerWater other = (PubMPowerWater) o;	        
