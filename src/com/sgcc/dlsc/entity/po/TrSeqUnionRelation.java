...
/**
 * TrSeqUnionRelation的POJO类
 *
 * @author  sss  [Tue Nov 12 11:06:01 CST 2013]
 * 
 */
public class TrSeqUnionRelation implements Serializable{
    ...
    /**
     * TrSeqUnionRelation构造函数
     */
    public TrSeqUnionRelation() {
        super();
    }  
	
    /**
     * TrSeqUnionRelation完整的构造函数
     */  
    public TrSeqUnionRelation(String guid,BigDecimal tradesequnionId,BigDecimal tradeseqId){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof TrSeqUnionRelation))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        TrSeqUnionRelation other = (TrSeqUnionRelation) o;	        
