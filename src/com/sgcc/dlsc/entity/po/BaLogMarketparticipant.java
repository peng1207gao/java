...
/**
 * BaLogMarketparticipant的POJO类
 *
 * @author  longshine  [Tue Mar 25 15:03:38 CST 2014]
 * 
 */
public class BaLogMarketparticipant implements Serializable{
    ...
    /**
     * BaLogMarketparticipant构造函数
     */
    public BaLogMarketparticipant() {
        super();
    }  
	
    /**
     * BaLogMarketparticipant完整的构造函数
     */  
    public BaLogMarketparticipant(String participantid,String participantname,BigDecimal participanttype,String participantcode,String marketid,Date starteffectivedate,String sheetid){
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof BaLogMarketparticipant))
	        return false; 
			
        if(getSheetid() == null) 
	        return false;

        BaLogMarketparticipant other = (BaLogMarketparticipant) o;	        
