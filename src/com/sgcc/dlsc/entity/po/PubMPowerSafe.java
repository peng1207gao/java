 ...
 * PubMPowerSafe的POJO类
 *
 * @author  yangguang  [Sat Mar 08 10:35:14 CST 2014]
 * 
 */
public class PubMPowerSafe implements Serializable{
     ...
     * 属性accidents1
     */
    private String accidents1;
	
    /** 
     * 属性accidents2
     */
    private String accidents2;
	
    /** 
     * 属性accidents3
     */
    private String accidents3;
     ...
     * PubMPowerSafe构造函数
     */
    public PubMPowerSafe() {
        super();
    }  
	
    /**
     * PubMPowerSafe完整的构造函数
     */  
    public PubMPowerSafe(String guid,String marketid,int tyear,int tmonth,int state,String fillinman,Date fillintime){
        this.guid = guid;
    ...
    /**
     * 属性 accidents1 的get方法
     * @return String
     */
    public String getAccidents1(){
        return accidents1;
    }
	
    /**
     * 属性 accidents1 的set方法
     * @return
     */
    public void setAccidents1(String accidents1){
        this.accidents1 = accidents1;
    } 
	
    /**
     * 属性 accidents2 的get方法
     * @return String
     */
    public String getAccidents2(){
        return accidents2;
    }
	
    /**
     * 属性 accidents2 的set方法
     * @return
     */
    public void setAccidents2(String accidents2){
        this.accidents2 = accidents2;
    } 
	
    /**
     * 属性 accidents3 的get方法
     * @return String
     */
    public String getAccidents3(){
        return accidents3;
    }
	
    /**
     * 属性 accidents3 的set方法
     * @return
     */
    public void setAccidents3(String accidents3){
        this.accidents3 = accidents3;
    } 
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof PubMPowerSafe))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        PubMPowerSafe other = (PubMPowerSafe) o;	        
	...
	public String toString(){
		  ...
		  return new StringBuffer()
            ...
            .append("accidents1"+":"+getAccidents1())
            .append("accidents2"+":"+getAccidents2())
            .append("accidents3"+":"+getAccidents3())
