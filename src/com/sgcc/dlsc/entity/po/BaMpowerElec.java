 ...
 * BaMpowerElec的POJO类
 *
 * @author  Administrator  [Wed Jul 17 16:34:08 CST 2013]
 * 
 */
public class BaMpowerElec implements Serializable{
     ...
     * BaMpowerElec完整的构造函数
     */  
    public BaMpowerElec(String guid,Date tabDate,BigDecimal datatype){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof BaMpowerElec))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        BaMpowerElec other = (BaMpowerElec) o;	        
