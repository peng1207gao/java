...
/**
 * PaCleanenergyAnalysisEp的POJO类
 *
 * @author  Administrator  [Tue Jun 18 16:00:26 CST 2013]
 * 
 */
public class PaCleanenergyAnalysisEp implements Serializable{
    ...
    /**
     * PaCleanenergyAnalysisEp构造函数
     */
    public PaCleanenergyAnalysisEp() {
        super();
    }  
	
    /**
     * PaCleanenergyAnalysisEp完整的构造函数
     */  
    public PaCleanenergyAnalysisEp(String guid,String marketid,Date querydate){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof PaCleanenergyAnalysisEp))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        PaCleanenergyAnalysisEp other = (PaCleanenergyAnalysisEp) o;	        
