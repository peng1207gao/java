...
/**
 * MktsbsResultNK的POJO类
 *
 * @author  Administrator  [Sat Jun 15 10:08:01 CST 2013]
 * 
 */
public class MktsbsResultNK implements Serializable{
     ...
     * MktsbsResultNK构造函数
     */
    public MktsbsResultNK() {
        super();
    }  
	
    /**
     * MktsbsResultNK完整的构造函数
     */  
    public MktsbsResultNK(String id,BigDecimal mktMonth,String bandIndex,Date startDate,Date endDate,String sbsUnitId,String recipientUnitId,String payerUnitId,String contractId,BigDecimal sbstypeId){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof MktsbsResultNK))
	        return false; 
			
        if(getId() == null) 
	        return false;

        MktsbsResultNK other = (MktsbsResultNK) o;	        
