 ...
 * PubMMacAdjust的POJO类
 *
 * @author  zndw1  [Mon Mar 10 16:40:22 CST 2014]
 * 
 */
public class PubMMacAdjust implements Serializable{
     ...
     * PubMMacAdjust构造函数
     */
    public PubMMacAdjust() {
        super();
    }  
	
    /**
     * PubMMacAdjust完整的构造函数
     */  
    public PubMMacAdjust(String guid,String marketid,Integer tyear,Integer tmonth,Integer state,String fillinman,Date fillintime){
        this.guid = guid;
     ...
     * @return
     */
    public void setAgctimes(BigDecimal agctimes){
        this.agctimes = agctimes;
    } 
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof PubMMacAdjust))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        PubMMacAdjust other = (PubMMacAdjust) o;	        
	...
	public String toString(){
		  ...
		  return new StringBuffer()
            ...
            .append("agctimes"+":"+getAgctimes())
            .append("volrate"+":"+getVolrate())
