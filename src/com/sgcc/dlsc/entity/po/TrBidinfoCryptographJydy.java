...
/**
 * TrBidinfoCryptographJydy的POJO类
 *
 * @author  Administrator  [Wed Feb 19 19:21:58 CST 2014]
 * 
 */
public class TrBidinfoCryptographJydy implements Serializable{
	...
	//加密标志
    private BigDecimal dataEncrpyFlag;
    private BigDecimal dataDisgerFlag;
    ...
    /**
     * TrBidinfoCryptographJydy构造函数
     */
    public TrBidinfoCryptographJydy() {
        super();
    }  
	
    /**
     * TrBidinfoCryptographJydy完整的构造函数
     */  
    public TrBidinfoCryptographJydy(String bidinfoid,BigDecimal tradeTimepart){
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof TrBidinfoCryptographJydy))
	        return false; 
			
        if(getBidinfoid() == null) 
	        return false;

        TrBidinfoCryptographJydy other = (TrBidinfoCryptographJydy) o;	        
	...
	public BigDecimal getDataEncrpyFlag() {
		return dataEncrpyFlag;
	}

	public void setDataEncrpyFlag(BigDecimal dataEncrpyFlag) {
		this.dataEncrpyFlag = dataEncrpyFlag;
	}

	public BigDecimal getDataDisgerFlag() {
		return dataDisgerFlag;
	}

	public void setDataDisgerFlag(BigDecimal dataDisgerFlag) {
		this.dataDisgerFlag = dataDisgerFlag;
	}
