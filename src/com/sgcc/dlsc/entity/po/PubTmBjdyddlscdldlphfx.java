...
/**
 * PubTmBjdyddlscdldlphfx的POJO类
 *
 * @author  Ronaldo  [Thu Jul 17 18:22:50 CST 2014]
 * 
 */
public class PubTmBjdyddlscdldlphfx implements Serializable{
     ...
     * 属性tdzdydfhr
     */
    private String tdzdydfhr;
	
    /** 
     * 属性zdlxdr
     */
    private String zdlxdr;
    ...
    /**
     * PubTmBjdyddlscdldlphfx构造函数
     */
    public PubTmBjdyddlscdldlphfx() {
        super();
    }  
	
    /**
     * PubTmBjdyddlscdldlphfx完整的构造函数
     */  
    public PubTmBjdyddlscdldlphfx(String guid,BigDecimal tyear,BigDecimal tmonth,String markerid,BigDecimal state,String fillinman,Date fillintime){
        this.guid = guid;
        this.tyear = tyear;
        this.tmonth = tmonth;
     ...
     * @return
     */
    public void setTdzdydfhr(String tdzdydfhr){
        this.tdzdydfhr = tdzdydfhr;
    } 
     ...
     * @return
     */
    public void setZdlxdr(String zdlxdr){
        this.zdlxdr = zdlxdr;
    } 
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof PubTmBjdyddlscdldlphfx))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        PubTmBjdyddlscdldlphfx other = (PubTmBjdyddlscdldlphfx) o;	        
	...
	public String toString(){
		  ...
		  return new StringBuffer()
            ...
            .append("tday"+":"+getTday())
            .append("tjxm"+":"+getTjxm())
            .append("tdzdydfhr"+":"+getTdzdydfhr())
            .append("zdlxdr"+":"+getZdlxdr())
