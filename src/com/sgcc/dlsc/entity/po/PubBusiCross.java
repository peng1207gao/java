 ...
 * PubBusiCross的POJO类
 *
 * @author  zndw1  [Mon Mar 03 11:27:12 CST 2014]
 * 
 */
public class PubBusiCross implements Serializable{
     ...
     * PubBusiCross完整的构造函数
     */  
    public PubBusiCross(String guid,String marketid,int tyear,int tmonth,BigDecimal state,String fillinman,Date fillintime){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof PubBusiCross))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        PubBusiCross other = (PubBusiCross) o;	        
