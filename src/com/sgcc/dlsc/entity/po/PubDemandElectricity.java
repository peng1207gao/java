...
/**
 * PubDemandElectricity的POJO类
 *
 * @author  zhangyr  [Sat Feb 15 17:39:50 CST 2014]
 * 
 */
public class PubDemandElectricity implements Serializable{
    ...
    /**
     * PubDemandElectricity构造函数
     */
    public PubDemandElectricity() {
        super();
    }  
	
    /**
     * PubDemandElectricity完整的构造函数
     */  
    public PubDemandElectricity(String guid,String marketid,int tyear,int tmonth,int state,String fillinman,Date fillintime){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof PubDemandElectricity))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        PubDemandElectricity other = (PubDemandElectricity) o;	        
