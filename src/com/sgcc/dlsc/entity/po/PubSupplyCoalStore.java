...
/**
 * PubSupplyCoalStore的POJO类
 *
 * @author  Administrator  [Sat Mar 08 20:53:21 CST 2014]
 * 
 */
public class PubSupplyCoalStore implements Serializable{
    ...
    /**
     * PubSupplyCoalStore构造函数
     */
    public PubSupplyCoalStore() {
        super();
    }  
	
    /**
     * PubSupplyCoalStore完整的构造函数
     */  
    public PubSupplyCoalStore(String guid,String marketid,BigDecimal tyear,BigDecimal tmonth,BigDecimal state,String fillinman,Date fillintime){
        this.guid = guid;
    ...
    /**
     * 属性 heatplants 的get方法
     * @return BigDecimal
     */
    public BigDecimal getHeatplants(){
        return heatplants;
    }
	
    /**
     * 属性 heatplants 的set方法
     * @return
     */
    public void setHeatplants(BigDecimal heatplants){
        this.heatplants = heatplants;
    } 
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof PubSupplyCoalStore))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        PubSupplyCoalStore other = (PubSupplyCoalStore) o;	        
	...
	public String toString(){
		  ...
		  return new StringBuffer()
            ...
            .append("heatplants"+":"+getHeatplants())
            .append("reserves"+":"+getReserves())
            .append("averagedays"+":"+getAveragedays())
