...
/**
 * PubBuildGeneDebug的POJO类
 *
 * @author  Administrator  [Fri Feb 28 14:25:42 CST 2014]
 * 
 */
public class PubBuildGeneDebug implements Serializable{
    ...
    /**
     * PubBuildGeneDebug构造函数
     */
    public PubBuildGeneDebug() {
        super();
    }  
	
    /**
     * PubBuildGeneDebug完整的构造函数
     */  
    public PubBuildGeneDebug(String guid,String marketid,int tyear,int tmonth,int state,String fillinman,Date fillintime){
        this.guid = guid;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof PubBuildGeneDebug))
	        return false; 
			
        if(getGuid() == null) 
	        return false;

        PubBuildGeneDebug other = (PubBuildGeneDebug) o;	        
